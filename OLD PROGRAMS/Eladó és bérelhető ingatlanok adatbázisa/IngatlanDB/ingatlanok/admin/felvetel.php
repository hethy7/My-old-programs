...
if ($sess = isset($_GET["sess"]))
	if (isset($_SESSION["adatok"])){
		...
		if (isset($_SESSION["adatok"]["felszereltseg"])){
			$felszereltseg = array();
			for ($i=1; $i<=7; $i++){
				if (in_array($i,$_SESSION["adatok"]["felszereltseg"])) $felszereltseg[$i] = true;
			}
		}
		//leiras ellenőrzés
			...
			<div id="doboz2">
				<div id="menu" >
					<ul>
						...
						<li class="aktOldal"><a href="felvetel.php"><b>Ingatlan felvétel</b></a></li>
				...
				<div id="doboz3">
					<div id="resz">
						<h2> Ingatlan felvétel </h2>
					</div>
					
					<div id="adaturlap">
						<form method="post" action="adminos/insert.php" enctype="multipart/form-data">
							<table>								
								<tr>
									...
									<td rowspan="8" id="kepekre">
										...
										<?php for($i=1; $i<=8; $i++){
										print '
										<img id="image'.$i.'" src="kepek/no_image.png" style="width: 66px; height: 60px;"/>
										<script>
								...
								<tr>
									<td colspan="2"> <span class="bevitel">
											...
											<?php if(isset($felszereltseg[1]) && ($felszereltseg[1])) print 'checked="checked"'; ?> /> víz </div> 
											<div class="felsz"> <input type="checkbox" name="felszereltseg[]" value="2" 
											<?php if(isset($felszereltseg[2]) && ($felszereltseg[2])) print 'checked="checked"'; ?> /> gáz </div>
											<div class="felsz"> <input type="checkbox" name="felszereltseg[]" value="3" 
											<?php if(isset($felszereltseg[3]) && ($felszereltseg[3])) print 'checked="checked"'; ?> /> villany </div>
											<div class="felsz"> <input type="checkbox" name="felszereltseg[]" value="4" 
											<?php if(isset($felszereltseg[4]) && ($felszereltseg[4])) print 'checked="checked"'; ?> /> központi fűtés </div>
											<div class="felsz"> <input type="checkbox" name="felszereltseg[]" value="5" 
											<?php if(isset($felszereltseg[5]) && ($felszereltseg[5])) print 'checked="checked"'; ?> /> pince </div>
											<div class="felsz"> <input type="checkbox" name="felszereltseg[]" value="6" 
											<?php if(isset($felszereltseg[6]) && ($felszereltseg[6])) print 'checked="checked"'; ?> /> csatorna </div>
											<div class="felsz"> <input type="checkbox" name="felszereltseg[]" value="7" 
											<?php if(isset($felszereltseg[7]) && ($felszereltseg[7])) print 'checked="checked"'; ?> /> garázs </div>
										</span> 
									</td>
								</tr>
								<tr>
							...
							<input type="submit" name="feltolt" class="btn" id="feltolt" value="Feltöltés" />
