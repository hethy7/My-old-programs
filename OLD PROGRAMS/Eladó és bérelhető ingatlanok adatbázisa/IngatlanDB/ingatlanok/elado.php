...
AND ingatlan_sz_kep = ingatlan_id AND kepek LIKE '%1.jpg' AND szandek = 'eladó'";
...
if (isset($_POST["keres"])){
	...
	$min = $_POST["min"]*1000000;
	$max = $_POST["max"]*1000000;
...
<html>
	...
	<body>
		<div id="fejlec">
			...
			<div id="menu" >
				<ul>
					...
					<li class="aktOldal"><a href="elado.php"><b>Eladó ingatlanok</b></a></li>
		...
		<div id="tartalom">
			...
			<hr>
			<div id="rendezes">
				<form action="elado.php?sess=1" method="post">
						...
						<div class="ingatlan">
							<a href="ingatlan.php?id='.$ingatlanok[$j]["ingatlan_id"].'">
								...
								<div class="ingatlanSzoveg">
									...
									<span class="ingatlanAr"> '.$ar.' Ft </span>
					...
					<span class="kereseshez">
						...
						<?php if (isset($_SESSION["kereses"]["min"]))
							  ...
							  if (isset($_SESSION["kereses"]["max"]))
								print '<input class="ar" type="text" name="max" placeholder="max" value='.$_SESSION["kereses"]["max"].' /> millió Ft';
							else print '<input class="ar" type="text" name="max" placeholder="max" /> millió Ft';
						?>
					</span>
			...
			<div id=oldalsz>
				...
				for($i=1; $i<=$oszn; $i++){
					...
					else print '<a href="elado.php?sess=1&osz='.$i.'" title="oldal'.$i.'"> '.$i.' </a>';
				}
				?>
				</div>
			</div>			
